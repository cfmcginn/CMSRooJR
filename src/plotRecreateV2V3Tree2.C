...
int plotRecreateV2V3(const std::string inFileName, const std::string inJamesFileName, const std::string inJamesFileName_v3)
{
  vanGoghPalette vg;
  ...
  */
  ...
  for(Int_t cI = 0; cI < nCentBins; ++cI){
    ...
    jamesHist_p[cI]->Fit(tmp_gaus,"QN0");
    TF1* jamesHist_f=new TF1("jamesHist_f", "gaus", tmp_gaus->GetParameter(1)-2*tmp_gaus->GetParameter(2), tmp_gaus->GetParameter(1)+2*tmp_gaus->GetParameter(2));
    jamesHist_p[cI]->Fit(jamesHist_f,"QNR0");

    jamesMean_p->SetBinContent(cI+1, jamesHist_f->GetParameter(1));
    jamesMean_p->SetBinError(cI+1, jamesHist_f->GetParError(1));

    jamesSigma_p->SetBinContent(cI+1, jamesHist_f->GetParameter(2));
    jamesSigma_p->SetBinError(cI+1, jamesHist_f->GetParError(2));
  ...
  TFile* jamesFile_v3_p = new TFile(inJamesFileName_v3.c_str(), "READ");
  TH1F* jamesHist_v3_p[nCentBins];
  TH1F* jamesMean_v3_p = new TH1F("jamesMean_v3_p", ";Centrality (%);#LTv_{2}^{obs}#GT", nCentBins, centBins);
  TH1F* jamesSigma_v3_p = new TH1F("jamesSigma_v3_p", ";Centrality (%);#sigma(v_{2}^{obs})", nCentBins, centBins);

  for(Int_t cI = 0; cI < nCentBins; ++cI){
    jamesHist_v3_p[cI] = (TH1F*)jamesFile_v3_p->Get(("qwebye/hVnFull_c" + std::to_string(cI+1)).c_str());

    jamesHist_v3_p[cI]->Fit(tmp_gaus,"QN0");
    TF1* jamesHist_v3_f=new TF1("jamesHist_v3_f", "gaus", tmp_gaus->GetParameter(1)-2*tmp_gaus->GetParameter(2), tmp_gaus->GetParameter(1)+2*tmp_gaus->GetParameter(2));
    jamesHist_v3_p[cI]->Fit(jamesHist_v3_f,"QNR0");

    jamesMean_v3_p->SetBinContent(cI+1, jamesHist_v3_f->GetParameter(1));
    jamesMean_v3_p->SetBinError(cI+1, jamesHist_v3_f->GetParError(1));

    jamesSigma_v3_p->SetBinContent(cI+1, jamesHist_v3_f->GetParameter(2));
    jamesSigma_v3_p->SetBinError(cI+1, jamesHist_v3_f->GetParError(2));

    centerTitles(jamesHist_v3_p[cI]);
    setSumW2(jamesHist_v3_p[cI]);


    jamesHist_v3_p[cI]->Scale(1./jamesHist_v3_p[cI]->Integral());
    jamesHist_v3_p[cI]->SetMaximum(jamesHist_v3_p[cI]->GetMaximum()*1.5);

    setColorStyleLabelTitle(jamesHist_v3_p[cI], 1, 20, 12, 14);
    jamesHist_v3_p[cI]->GetYaxis()->SetTitleOffset(jamesHist_v3_p[cI]->GetYaxis()->GetTitleOffset()*1.5);
    jamesHist_v3_p[cI]->SetTitle("");

    delete jamesHist_v3_f;
  }

  centerTitles({jamesMean_v3_p, jamesSigma_v3_p});
  setSumW2({jamesMean_v3_p, jamesSigma_v3_p});
  jamesMean_v3_p->SetMaximum(jamesMean_v3_p->GetMaximum()*1.5);
  jamesMean_v3_p->SetMinimum(0.0);

  setColorStyleLabelTitle(jamesMean_v3_p, 1, 20, 12, 14);
  jamesMean_v3_p->GetYaxis()->SetTitleOffset(jamesHist_v3_p[0]->GetYaxis()->GetTitleOffset());

  jamesSigma_v3_p->SetMaximum(jamesSigma_v3_p->GetMaximum()*1.5);
  jamesSigma_v3_p->SetMinimum(0.0);
  setColorStyleLabelTitle(jamesSigma_v3_p, 1, 20, 12, 14);
  jamesSigma_v3_p->GetYaxis()->SetTitleOffset(jamesHist_v3_p[0]->GetYaxis()->GetTitleOffset());
  ...
  TH1F* v3Raw_Mean_PF_h = (TH1F*)inFile_p->Get("v3Raw_Mean_PF_h");
  TH1F* v3Raw_Sigma_PF_h = (TH1F*)inFile_p->Get("v3Raw_Sigma_PF_h");

  TH1F* v3RawCorr_Mean_PF_h = (TH1F*)inFile_p->Get("v3RawCorr_Mean_PF_h");
  TH1F* v3RawCorr_Sigma_PF_h = (TH1F*)inFile_p->Get("v3RawCorr_Sigma_PF_h");

  TH1F* v3Fit_Mean_PF_h = (TH1F*)inFile_p->Get("v3Fit_Mean_PF_h");
  TH1F* v3Fit_Sigma_PF_h = (TH1F*)inFile_p->Get("v3Fit_Sigma_PF_h");

  TH1F* v3ObsCorr_Mean_PF_h = (TH1F*)inFile_p->Get("v3ObsCorr_Mean_PF_h");
  TH1F* v3ObsCorr_Sigma_PF_h = (TH1F*)inFile_p->Get("v3ObsCorr_Sigma_PF_h");
  ...
  TH1F* pt_h = (TH1F*)inFile_p->Get("pt_h");
  TH1F* pt_rawPlus_h = (TH1F*)inFile_p->Get("pt_rawPlus_h");
  TH1F* pt_rawMinus_h = (TH1F*)inFile_p->Get("pt_rawMinus_h");
  TH1F* pt_rawCorrPlus_h = (TH1F*)inFile_p->Get("pt_rawCorrPlus_h");
  TH1F* pt_rawCorrMinus_h = (TH1F*)inFile_p->Get("pt_rawCorrMinus_h");

  TH1F* phi_h = (TH1F*)inFile_p->Get("phi_h");
  TH1F* phi_rawPlus_h = (TH1F*)inFile_p->Get("phi_rawPlus_h");
  TH1F* phi_rawMinus_h = (TH1F*)inFile_p->Get("phi_rawMinus_h");
  TH1F* phi_rawCorrPlus_h = (TH1F*)inFile_p->Get("phi_rawCorrPlus_h");
  TH1F* phi_rawCorrMinus_h = (TH1F*)inFile_p->Get("phi_rawCorrMinus_h");
  */
  for(Int_t cI = 0; cI < nCentBins; ++cI){
    ...
    v2Fit_PF_h[cI] = (TH1F*)inFile_p->Get(("v2Fit_" + centStr + "_PF_h").c_str());
    ...
    centerTitles({v2Raw_PF_h[cI], v2RawCorr_PF_h[cI], v2ObsCorr_PF_h[cI], v2Fit_PF_h[cI], v2Diff_PF_h[cI], v2DiffCorr_PF_h[cI]});
    ...
    setSumW2({v2Raw_PF_h[cI], v2RawCorr_PF_h[cI], v2ObsCorr_PF_h[cI], v2Fit_PF_h[cI], v2Diff_PF_h[cI], v2DiffCorr_PF_h[cI]});
    ...
    setColorStyleLabelTitle(v2Fit_PF_h[cI], vg.getColor(2), flowStyleSet[2], 12, 14);
    ...
    v2Raw_PF_h[cI]->Scale(1./v2Raw_PF_h[cI]->Integral());
    v2RawCorr_PF_h[cI]->Scale(1./v2RawCorr_PF_h[cI]->Integral());
    v2ObsCorr_PF_h[cI]->Scale(1./v2ObsCorr_PF_h[cI]->Integral());
    v2Fit_PF_h[cI]->Scale(1./v2Fit_PF_h[cI]->Integral());
    ...
    v2Raw_PF_h[cI]->GetYaxis()->SetTitleOffset(jamesHist_p[cI]->GetYaxis()->GetTitleOffset());
    v2Raw_PF_h[cI]->GetXaxis()->SetTitleOffset(jamesHist_p[cI]->GetYaxis()->GetTitleOffset()*1.5);       
    ...
    v3Raw_PF_h[cI] = (TH1F*)inFile_p->Get(("v3Raw_" + centStr + "_PF_h").c_str());
    v3RawCorr_PF_h[cI] = (TH1F*)inFile_p->Get(("v3RawCorr_" + centStr + "_PF_h").c_str());
    v3ObsCorr_PF_h[cI] = (TH1F*)inFile_p->Get(("v3ObsCorr_" + centStr + "_PF_h").c_str());
    v3Fit_PF_h[cI] = (TH1F*)inFile_p->Get(("v3Fit_" + centStr + "_PF_h").c_str());
    v3Diff_PF_h[cI] = (TH1F*)inFile_p->Get(("v3Diff_" + centStr + "_PF_h").c_str());
    v3DiffCorr_PF_h[cI] = (TH1F*)inFile_p->Get(("v3DiffCorr_" + centStr + "_PF_h").c_str());

    centerTitles({v3Raw_PF_h[cI], v3RawCorr_PF_h[cI], v3ObsCorr_PF_h[cI], v3Fit_PF_h[cI], v3Diff_PF_h[cI], v3DiffCorr_PF_h[cI]});
    setSumW2({v3Raw_PF_h[cI], v3RawCorr_PF_h[cI], v3ObsCorr_PF_h[cI], v3Fit_PF_h[cI], v3Diff_PF_h[cI], v3DiffCorr_PF_h[cI]});

    setColorStyleLabelTitle(v3Raw_PF_h[cI], vg.getColor(0), flowStyleSet[0], 12, 14);
    setColorStyleLabelTitle(v3RawCorr_PF_h[cI], vg.getColor(1), flowStyleSet[1], 12, 14);
    setColorStyleLabelTitle(v3ObsCorr_PF_h[cI], vg.getColor(2), flowStyleSet[2], 12, 14);
    setColorStyleLabelTitle(v3Fit_PF_h[cI], vg.getColor(2), flowStyleSet[2], 12, 14);
    setColorStyleLabelTitle(v3Diff_PF_h[cI], vg.getColor(0), flowStyleSet[0], 12, 14);
    setColorStyleLabelTitle(v3DiffCorr_PF_h[cI], vg.getColor(0), flowStyleSet[0], 12, 14);

    v3Raw_PF_h[cI]->Scale(1./v3Raw_PF_h[cI]->Integral());
    v3RawCorr_PF_h[cI]->Scale(1./v3RawCorr_PF_h[cI]->Integral());
    v3ObsCorr_PF_h[cI]->Scale(1./v3ObsCorr_PF_h[cI]->Integral());
    v3Fit_PF_h[cI]->Scale(1./v3Fit_PF_h[cI]->Integral());

    v3Raw_PF_h[cI]->GetYaxis()->SetTitleOffset(jamesHist_p[cI]->GetYaxis()->GetTitleOffset());
    v3Raw_PF_h[cI]->GetXaxis()->SetTitleOffset(jamesHist_p[cI]->GetYaxis()->GetTitleOffset()*1.5);

    if(cI == 0){
      leg_PF_p->AddEntry(v2Raw_PF_h[cI], "Jet Extraction", "P L");
      leg_PF_p->AddEntry(v2RawCorr_PF_h[cI], "Eff. Corr.", "P L");
      leg_PF_p->AddEntry(v2Fit_PF_h[cI], "Fit", "P L");
  ...
  centerTitles({v3Raw_Mean_PF_h, v3Raw_Sigma_PF_h, v3RawCorr_Mean_PF_h, v3RawCorr_Sigma_PF_h, v3Fit_Mean_PF_h, v3Fit_Sigma_PF_h, v3ObsCorr_Mean_PF_h, v3ObsCorr_Sigma_PF_h});
  setSumW2({v3Raw_Mean_PF_h, v3Raw_Sigma_PF_h, v3RawCorr_Mean_PF_h, v3RawCorr_Sigma_PF_h, v3Fit_Mean_PF_h, v3Fit_Sigma_PF_h, v3ObsCorr_Mean_PF_h, v3ObsCorr_Sigma_PF_h});

  setColorStyleLabelTitle(v3Raw_Mean_PF_h, vg.getColor(0), flowStyleSet[0], 12, 14);
  setColorStyleLabelTitle(v3RawCorr_Mean_PF_h, vg.getColor(1), flowStyleSet[1], 12, 14);
  setColorStyleLabelTitle(v3Fit_Mean_PF_h, vg.getColor(2), flowStyleSet[2], 12, 14);
  setColorStyleLabelTitle(v3ObsCorr_Mean_PF_h, vg.getColor(2), flowStyleSet[2], 12, 14);

  setColorStyleLabelTitle(v3Raw_Sigma_PF_h, vg.getColor(0), flowStyleSet[0], 12, 14);
  setColorStyleLabelTitle(v3RawCorr_Sigma_PF_h, vg.getColor(1), flowStyleSet[1], 12, 14);
  setColorStyleLabelTitle(v3Fit_Sigma_PF_h, vg.getColor(2), flowStyleSet[2], 12, 14);
  setColorStyleLabelTitle(v3ObsCorr_Sigma_PF_h, vg.getColor(2), flowStyleSet[2], 12, 14);
  ...
  pt_h->Draw();
  canv_p->SaveAs("pt.pdf");
  pt_rawPlus_h->Draw();
  canv_p->SaveAs("pt_rawPlus.pdf");
  pt_rawMinus_h->Draw();
  canv_p->SaveAs("pt_rawMinus.pdf");
  pt_rawCorrPlus_h->Draw();
  canv_p->SaveAs("pt_rawCorrPlus.pdf");
  pt_rawCorrMinus_h->Draw();
  canv_p->SaveAs("pt_rawCorrMinus.pdf");

  phi_h->Draw();
  canv_p->SaveAs("phi.pdf");
  phi_rawPlus_h->Draw();
  canv_p->SaveAs("phi_rawPlus.pdf");
  phi_rawMinus_h->Draw();
  canv_p->SaveAs("phi_rawMinus.pdf");
  phi_rawCorrPlus_h->Draw();
  canv_p->SaveAs("phi_rawCorrPlus.pdf");
  phi_rawCorrMinus_h->Draw();
  canv_p->SaveAs("phi_rawCorrMinus.pdf");
  */
  gStyle->SetOptStat(0);
  ...
  */
  ...
  for(Int_t cI = 0; cI < nCentBins; ++cI){
    ...
    v2Raw_PF_h[cI]->DrawCopy("HIST P SAME");
    v2RawCorr_PF_h[cI]->DrawCopy("HIST P SAME");
    v2Fit_PF_h[cI]->DrawCopy("HIST P SAME");
    ...
    label_PF_p->DrawLatex(0.25, 0.82, ("#bf{" + centStr2 + "}").c_str());
    leg_PF_p->Draw("SAME");
    ...
    v2Raw_PF_h[cI]->Divide(jamesHist_p[cI]);
    v2RawCorr_PF_h[cI]->Divide(jamesHist_p[cI]);
    v2Fit_PF_h[cI]->Divide(jamesHist_p[cI]);
    
    v2Raw_PF_h[cI]->SetMinimum(0.55);
    v2Raw_PF_h[cI]->SetMaximum(1.45);
    
    v2Raw_PF_h[cI]->GetYaxis()->SetNdivisions(505);

    v2Raw_PF_h[cI]->DrawCopy("HIST P");
    v2RawCorr_PF_h[cI]->DrawCopy("SAME HIST P");
    v2Fit_PF_h[cI]->DrawCopy("SAME HIST P");
    
    gStyle->SetOptStat(0);

    const std::string centStr = "Cent" + std::to_string(centBinsLow[cI]) + "to" + std::to_string(centBinsHi[cI]);
    const std::string saveName = "plotRecreateV2James_" + centStr + "_" + dateStr + "_PF.pdf";
  ...
  max=jamesMean_v3_p->GetMaximum();
  if (v3Raw_Mean_PF_h->GetMaximum()>max) max=v3Raw_Mean_PF_h->GetMaximum();
  if (v3RawCorr_Mean_PF_h->GetMaximum()>max) max=v3RawCorr_Mean_PF_h->GetMaximum();
  if (v3ObsCorr_Mean_PF_h->GetMaximum()>max) max=v3ObsCorr_Mean_PF_h->GetMaximum();
  jamesMean_v3_p->SetMaximum(1.5*max);
  jamesMean_v3_p->SetTitle("Mean (PF)");
  jamesMean_v3_p->Draw("HIST E1 P");
  v3Raw_Mean_PF_h->Draw("SAME HIST E1 P");
  v3RawCorr_Mean_PF_h->Draw("SAME HIST E1 P");
  v3Fit_Mean_PF_h->Draw("SAME HIST E1 P");
  leg_PF_p->Draw("SAME");
  canv_p->SaveAs("Mean_v3_PF.pdf");

  max=jamesSigma_v3_p->GetMaximum();
  if (v3Raw_Sigma_PF_h->GetMaximum()>max) max=v3Raw_Sigma_PF_h->GetMaximum();
  if (v3RawCorr_Sigma_PF_h->GetMaximum()>max) max=v3RawCorr_Sigma_PF_h->GetMaximum();
  if (v3ObsCorr_Sigma_PF_h->GetMaximum()>max) max=v3ObsCorr_Sigma_PF_h->GetMaximum();
  jamesSigma_v3_p->SetMaximum(1.5*max);
  jamesSigma_v3_p->SetTitle("Sigma (PF)");
  jamesSigma_v3_p->Draw("HIST P");
  v3Raw_Sigma_PF_h->Draw("SAME HIST P");
  v3RawCorr_Sigma_PF_h->Draw("SAME HIST P");
  v3Fit_Sigma_PF_h->Draw("SAME HIST P");
  leg_PF_p->Draw("SAME");
  canv_p->SaveAs("Sigma_v3_PF.pdf");

  gStyle->SetOptStat(1111);
  for(Int_t cI = 0; cI < nCentBins; ++cI){
    const std::string centStr = "Cent" + std::to_string(centBinsLow[cI]) + "to" + std::to_string(centBinsHi[cI]);
    const std::string saveName = "v3Diff_" + centStr + "_" + dateStr + "_PF.pdf";
    ...
    //    TH1F* tmp = new TH1F(("tmp" + centStr).c_str(), ("v3ObsCorr_PF/v3FromTree (" + centStr + ");v_{3};").c_str(), 150, 0.0, 0.6);
    //    v3FT_h[cI]->Divide(v3ObsCorr_PF_h[cI],v3FT_h[cI]);
    //    v3FT_h[cI]->SetTitle(("v3ObsCorr_PF/v3FromTree (" + centStr + ");v_{3};").c_str());
    //    v3FT_h[cI]->SetMaximum(3.0);
    v3Diff_PF_h[cI]->DrawCopy("HIST P");

    canv_p->SaveAs(saveName.c_str());
  }
  for(Int_t cI = 0; cI < nCentBins; ++cI){
    const std::string centStr = "Cent" + std::to_string(centBinsLow[cI]) + "to" + std::to_string(centBinsHi[cI]);
    const std::string saveName = "v3DiffCorr_" + centStr + "_" + dateStr + "_PF.pdf";
    ...
    //    v3FT_h[cI]->SetTitle(("v3ObsCorr_PF/v3FromTree (" + centStr + ");v_{3};").c_str());
    //    v3FT_h[cI]->SetMaximum(3.0);
    v3DiffCorr_PF_h[cI]->DrawCopy("HIST P");
  ...
  for(Int_t cI = 0; cI < nCentBins; ++cI){
    ...
    jamesHist_v3_p[cI]->DrawCopy("HIST P");
    v3Raw_PF_h[cI]->DrawCopy("HIST P SAME");
    v3RawCorr_PF_h[cI]->DrawCopy("HIST P SAME");
    v3Fit_PF_h[cI]->DrawCopy("HIST P SAME");
    ...
    v3Raw_PF_h[cI]->Divide(jamesHist_v3_p[cI]);
    v3RawCorr_PF_h[cI]->Divide(jamesHist_v3_p[cI]);
    v3Fit_PF_h[cI]->Divide(jamesHist_v3_p[cI]);

    v3Raw_PF_h[cI]->SetMinimum(0.55);
    v3Raw_PF_h[cI]->SetMaximum(1.45);

    v3Raw_PF_h[cI]->GetYaxis()->SetNdivisions(505);

    v3Raw_PF_h[cI]->DrawCopy("HIST P");
    v3RawCorr_PF_h[cI]->DrawCopy("SAME HIST P");
    v3Fit_PF_h[cI]->DrawCopy("SAME HIST P");

    gStyle->SetOptStat(0);

    const std::string centStr = "Cent" + std::to_string(centBinsLow[cI]) + "to" + std::to_string(centBinsHi[cI]);
    const std::string saveName = "plotRecreateV3James_" + centStr + "_" + dateStr + "_PF.pdf";
  ...
  */
  ...
  jamesFile_v3_p->Close();
  delete jamesFile_v3_p;
...
{
  if(argc != 4){
    std::cout << "Usage: ./plotRecreateV2V3.exe <inFileName> <inJamesFileName> <inJamesFileName_v3>" << std::endl;
    return 1;
  }

  int retVal = 0;
  retVal += plotRecreateV2V3(argv[1], argv[2], argv[3]);
  return retVal;
}
